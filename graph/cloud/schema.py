...
class MedicalCondition(BaseModel):
    ...
    severity: str = "Moderate"  # e.g., Mild, Moderate, Severe
...
class PatientMedicalHistory(BaseModel):
    patient_id: str
    age: int
    chronic_conditions: List[MedicalCondition] = Field(default_factory=list)
    current_medications: List[Medication] = Field(default_factory=list)
    allergies: List[str] = Field(default_factory=list)
    past_dental_procedures: List[str] = Field(default_factory=list)